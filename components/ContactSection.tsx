            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-rose-100 hover:border-rose-200">
              <div className="flex gap-4 items-start relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <a
                    href="https://wa.me/6281234567890?text=Assalamualaikum%2C%20saya%20ingin%20tanya%20tentang%20produk%20di%20MyeonBeautybliss"
                    target="_blank"
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-rose-100 hover:border-rose-200">
              <div className="flex gap-4 items-start relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3">hello@myeonbeauty.com</p>
                  <a
